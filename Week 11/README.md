1.1
(1,000,000bp*3)/100bp= 30,000 of 100bp reads are needed
...
1.6
1. There is 0 frequency of this genome that has not been sequenced.
2. The Poisson expected number of uncovered positions is very small and matches the histogram well. The Normal distribution fits better at higher coverage, forming a Gaussian-like curve centered around 30 coverage.

2.4
dot -Tpng edges.dot -o ex2_digraph.png

2.5
One possible sequence is TTC-TCA-CAT-ATT-TTT

2.6
It would take the genome to not have gaps in the sequence that leads to data that is ambiguous.